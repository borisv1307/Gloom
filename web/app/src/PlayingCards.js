    ...
    render() {
	    ...
	    return (
	      <div className="drag-container">
	        ...
	        <div className="played-cards" style={{display:"flex", justifyContent:"space-evenly"}}
	        	onDragOver={(event)=>this.onDragOver(event)}
          		onDrop={(event)=>this.onDrop(event, "playedCards")}>
	          <span className="group-header">Played Cards</span>
	          {tasks.playedCards}
	        </div>
