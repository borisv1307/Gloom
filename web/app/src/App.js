        ...
        return(
            <div className="roomButtonComponent">
                <div className="buttonsDiv" >
                                <button id="roomButton1" className="roomButton"  onClick={()=>showRoomAndMonster("1")}>Room1</button>
                                <button id="roomButton2" className="roomButton" onClick={()=>showRoomAndMonster("2")}>Room2</button>
                                <button id="roomButton3" className="roomButton" onClick={()=>showRoomAndMonster("3")}>Room3</button>
                </div>
